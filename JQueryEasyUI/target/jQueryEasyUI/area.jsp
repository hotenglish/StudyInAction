...
<!-- 对话框 -->
<div id="#wedit" class="easyui-window" data-options="title:'地市管理',iconCls:'icon-save',modal:true,closed:true"
    ...
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:center,border:false" style="padding: 10px; background: #fff;
            ...
            <iframe id="maindata" scrolling="yes" frameborder="0" scr="#" style="width: 100%;
                    height: 98%;"></iframe>
        </div>
    </div>
</div>

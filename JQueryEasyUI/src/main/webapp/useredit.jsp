        ...
        <div id="maindata">
            ...
            <table class="table table-hover table-condensed">
                <tr>
                    <th>地市</th>
                    <td>
                        <input id="AREAICODE" type="text" class="easyui-combotree span2"
                               data-options="url:'AREAFindTree.action',required:true">
                    </td>
                    <th>姓名</th>
                    <td>
                        <input id="NAME" type="text" class="easyui-validatebox span2" data-options="required:true">
                    </td>
                </tr>
                <tr>
                    <th>登录账号</th>
                    <td>
                        <input id="LOGINNAME" type="text" class="easyui-validatebox span2">
                    </td>
                    <th>登录密码</th>
                    <td>
                        <input id="PASSWORD" type="text" class="easyui-validatebox span2">
                    </td>
                </tr>
                <tr>
                    <th>联系电话</th>
                    <td colspan="3">
                        <input id="PHONE" type="text" class="span2">
                    </td>
                </tr>
                <tr>
                    <th>电子邮箱</th>
                    <td colspan="3">
                        <input id="EMAIL" type="text" class="span5" style="width:322px;">
                    </td>
                </tr>
            </table>
        </div>

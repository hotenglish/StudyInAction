...
public class JdbcSpittleRepository implements SpittleRepository {
    ...
    private static final String SELECT_SPITTLE = "select sp.id, s.id as spitterId, s.username, s.password, " +
            "s.fullname, s.email, s.updateByEmail, sp.message, sp.postedTime from Spittle sp, Spitter s " +
            "where sp.spitter = s.id";
    ...
    @Override
    public long count() {
        return jdbcTemplate.queryForLong("select count(*) from Spittle");
    }

insert into Spitter (username, password, first_name, email, last_name) values ('habuma', 'password', 'Craig Walls', 'craig@habuma.com', '');
insert into Spitter (username, password, first_name, email, last_name) values ('mwalls', 'password', 'Michael Walls', 'mwalls@habuma.com', '');
insert into Spitter (username, password, first_name, email, last_name) values ('chuck', 'password', 'Chuck Wagon', 'chuck@habuma.com', '');
insert into Spitter (username, password, first_name, email, last_name) values ('artnames', 'password', 'Art Names', 'art@habuma.com', '');

...
public class MongoDbTest {
    ...
    public void testMongoRepository() {
        ...
        List<Order> chunksOrdres = orderRepository.findByCustomer("Chuck Wagon");
        assertEquals(1, chunksOrdres.size());
        assertEquals("Chuck Wagon", chunksOrdres.get(0).getCustomer());
        assertEquals(2, chunksOrdres.get(0).getItems().size());

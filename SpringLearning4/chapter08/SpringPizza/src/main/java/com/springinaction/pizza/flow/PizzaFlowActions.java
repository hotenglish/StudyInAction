...
public class PizzaFlowActions {
    public static final Logger LOGGER = Logger.getLogger(PizzaFlowActions.class);

    public Customer lookupCustomer(String phoneNumber) throws CustomerNotFoundException {
        Customer customer = customerService.lookup(phoneNumber);
        if (customer != null) {
            return customer;
        } else {
    ...
    public Payment verifyPayment(PaymentDetails paymentDetails) throws Exception {

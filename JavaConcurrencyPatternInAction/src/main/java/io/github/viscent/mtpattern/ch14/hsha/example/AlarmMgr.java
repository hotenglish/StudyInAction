...
public class AlarmMgr {
    // 保存AlarmMgr类的唯一实例
    public static final AlarmMgr INSTANCE =new AlarmMgr();
    ...
    private AlarmMgr() {
        ...
        alarmSendingThread.setName("AlarmSendingThread");
    }
    //返回类AlarmMgr的唯一实例
    ...
    public synchronized void shutdown(){
        ...
        Debug.info("Executing AlarmSendingThread shutdown,now its threadcount is "+
                alarmSendingThread.getThreadCount()+" and reservationcount is "+
                alarmSendingThread.getReservationCount());

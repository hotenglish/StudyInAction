...
import io.github.viscent.mtpattern.ch6.example.FTPClientUtil;
...
public class DataSyncTask implements Runnable {
    ...
    private SimplePipeline<RecordSaveTask, String> buildPipeLine() {
		 ...
		 */
        final ExecutorService helpExecutor = Executors.newSingleThreadExecutor();
        ...
        Pipe<RecordSaveTask, File> stageSaveFile = new AbstractPipe<RecordSaveTask, File>() {
            ...
            protected File doProcess(RecordSaveTask task) throws PipeException {
                ...
                File file;
                if (null == records) {
                    file = recordWriter.finishedRecords(task.recordDay,
        ...
        Pipe<File, File> stageTransferFile = new AbstractParallelPipe<File, File, File>(
            ...
            @Override
            protected File combinesResults(List<Future<File>> subTaskResults)
                throws Exception {

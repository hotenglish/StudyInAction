...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', 'zhangsan', '张三', CURRENT_DATE(), '0', '1325656546', 'lfkdsj@dlkjf.com', 'fdsafljdsakf');
INSERT INTO `t_user` VALUES ('2', 'zlkjklfdsa', '李四', CURRENT_DATE(), '1', '1325656546', 'lfkdsj@dlkjf.com', 'fdsafljdsakf');
INSERT INTO `t_user` VALUES ('3', 'wangwuz', '王五', CURRENT_DATE(), '2', '1265445', '211321@fdsaf.com', '2');
...
CREATE PROCEDURE `count_role`(in p_role_name varchar(60), out count_total int, out exec_date date)
BEGIN
    select count(*) INTO count_total from t_role where role_name like concat('%',p_role_name,'%');
    SET exec_date = CURRENT_DATE();
END

call count_role('me11',@count_total,@exec_date);
select @count_total as total,@exec_date as my_date;

DROP TABLE IF EXISTS `t_color`;
CREATE TABLE `t_color` (
  `id`    int(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `color` int(20) NOT NULL COMMENT '颜色名称',
  `note`  varchar(1024) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

INSERT INTO `t_color` VALUES ('1', '1', '黄色');

DROP TABLE IF EXISTS `t_bill_2017`;
CREATE TABLE `t_bill_2017` (
  `id`    int(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `bill_name` varchar(60) NOT NULL COMMENT '帐户名称',
  `note`  varchar(1024) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

INSERT INTO `t_bill_2017` VALUES ('1', 'bill_2017_1', 'bill1');
INSERT INTO `t_bill_2017` VALUES ('2', 'bill_2017_2', 'bill2');

DROP TABLE IF EXISTS `t_bill_2018`;
CREATE TABLE `t_bill_2018` (
  `id`    int(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `bill_name` varchar(60) NOT NULL COMMENT '帐户名称',
  `note`  varchar(1024) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
...
INSERT INTO `t_bill_2018` VALUES ('1', 'bill_2018_1', 'bill1');
INSERT INTO `t_bill_2018` VALUES ('2', 'bill_2018_2', 'bill2');

DROP TABLE IF EXISTS `t_file`;
CREATE TABLE `t_file` (
  `id`    int(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `title` varchar(60) NOT NULL COMMENT '帐户名称',
  `filePath`  varchar(1024) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

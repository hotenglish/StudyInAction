...
public class ReadingListController {
    ...
    public String readersBooks(Reader reader, Model model) {
        if(reader==null){
            UserDetails userDetails =readerRepository.findOne("maosheng");
            reader=new Reader();
            reader.setUsername(userDetails.getUsername());
            reader.setFullname(userDetails.getUsername());
            reader.setPassword(userDetails.getPassword());
        }
